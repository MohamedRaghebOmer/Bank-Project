...
private:
	...
	static  vector <clsBankClient> _LoadClientsDataFromFile()
	{
		...
		fstream MyFile;
		MyFile.open("D:\\GitHub\\Bank-Project\\Data\\Clients.txt", ios::in);//read Mode
	...
	static void _SaveCleintsDataToFile(vector <clsBankClient>& vClients)
	{
		...
		fstream MyFile;
		MyFile.open("D:\\GitHub\\Bank-Project\\Data\\Clients.txt", ios::out);//overwrite
	...
	{
		fstream MyFile;
		MyFile.open("D:\\GitHub\\Bank-Project\\Data\\Clients.txt", ios::out | ios::app);
	...
	{
		fstream myFile;
		myFile.open("D:\\GitHub\\Bank-Project\\Data\\transfer_log.txt", ios::out | ios::app);
...
public:
	...
	* No UI related inside object
	...
	enSaveResults Save()
	{
		...
		default: { return enSaveResults::svFaildEmptyObject; }
		}
	}
	...
	{
		fstream myFile;
		myFile.open("D:\\GitHub\\Bank-Project\\Data\\transfer_log.txt", ios::in);
